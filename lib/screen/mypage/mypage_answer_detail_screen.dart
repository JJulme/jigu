...
class MypageAnswerDetailScreen extends StatefulWidget {
  const MypageAnswerDetailScreen({super.key});

  @override
  State<MypageAnswerDetailScreen> createState() =>
      _MypageAnswerDetailScreenState();
}

class _MypageAnswerDetailScreenState extends State<MypageAnswerDetailScreen> {
  @override
